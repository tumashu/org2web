#+TITLE:       Tips of org2web
#+AUTHOR:      Feng Shu
#+EMAIL:       tumashu@163.com
#+DATE:        2015-04-01


* How to install org2web in manual way

To install org2web manually you should first install all
dependencies listed in *README.org*. Once this has been completed,
clone the repo:

#+BEGIN_EXAMPLE
git clone https://github.com/tumashu/org2web.git
#+END_EXAMPLE
...
(add-to-list 'load-path "/path/to/org2web")
(require 'org2web)
#+END_SRC

NOTE: This is NOT recommended way for emacs beginner.

* How to install org2web Through package management system
...
#+BEGIN_EXAMPLE
M-x org2web-insert-options-template
#+END_EXAMPLE
...
#+BEGIN_EXAMPLE
:remote (git "<your-html-git-remote-url>" "<branch-name>")
#+END_EXAMPLE
...
#+BEGIN_SRC emacs-lisp
(setq org2web-category-config-alist
